...
//    uvm_config_wrapper::set(this, $sformatf("%s.mcseqr.run_phase", m_tb_name), "default_sequence", i2c_write_mc_seq::get_type());
...
//         uvm_config_db#(string)::set(null, "*", "CUR_SEQ_NAME","i2c_write_mc_seq");      
...
//     // Set the default sequence for the clock
//    uvm_config_wrapper::set(this, $sformatf("%s.mcseqr.run_phase", m_tb_name), "default_sequence", i2c_read_mc_seq::get_type());
//     uvm_config_wrapper::set(this, $sformatf("%s.clk_rst_env.agent.sequencer.run_phase", m_tb_name), "default_sequence", clk10_rst5_seq::get_type());
//      uvm_config_db#(string)::set(null, "*", "CUR_TEST_NAME", get_type_name());       
//         uvm_config_db#(string)::set(null, "*", "CUR_SEQ_NAME","i2c_read_mc_seq");      
//         uvm_config_db#(string)::set(null, "*", "PERIPHERAL","I2C");  
...
//     uvm_config_db#(string)::set(null, "*", "CUR_TEST_NAME", get_type_name());       
//         uvm_config_db#(string)::set(null, "*", "CUR_SEQ_NAME","i2c_status_mc_seq");      
//         uvm_config_db#(string)::set(null, "*", "PERIPHERAL","I2C");  
...
class wb_i2c_test extends base_test;
  ...
  function void build_phase(uvm_phase phase);
    ...
    // Set default test info for reporting
    uvm_config_db#(string)::set(null, "*", "CUR_TEST_NAME", get_type_name());
    uvm_config_db#(string)::set(null, "*", "CUR_SEQ_NAME", "i2c_status_mc_seq");
    uvm_config_db#(string)::set(null, "*", "PERIPHERAL", "I2C");

    // You can uncomment one of the following:
    // uvm_config_wrapper::set(this, $sformatf("%s.mcseqr.run_phase", m_tb_name), "default_sequence", i2c_write_to_wrong_addr_mc_seq::get_type());
    // uvm_config_wrapper::set(this, $sformatf("%s.mcseqr.run_phase", m_tb_name), "default_sequence", i2c_multiple_write_mc_seq::get_type());
  endfunction
