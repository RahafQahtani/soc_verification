class wb_uart_tb  extends uvm_env;
    ...
    //uart_module_uvc
    wb_uart_module_env m_wb_uart_module_env;

    `uvm_component_utils(wb_uart_tb)
    //Class constructor
    function new(string name = "wb_uart_tb", uvm_component parent = null);
    ...
    function void build_phase(uvm_phase phase);
      ...
      //UART Module UVC
      m_wb_uart_module_env = wb_uart_module_env ::type_id::create("m_wb_uart_module_env", this);
    ...
    function void connect_phase(uvm_phase phase);
      ...
      m_wb_env.m_wb_agent.m_wb_monitor.wb_analysis_port.connect(m_wb_uart_module_env.m_wb_uart_ref_model.wb_analysis_imp);
//      m_wb_env.m_wb_agent.m_wb_monitor.wb_analysis_port.connect(m_uart_module.uart_sbd.wb_uart_analysis_imp);
      m_uart_env.m_uart_tx_agent.m_uart_tx_monitor.uart_tx_analysis_port.connect(m_wb_uart_module_env.m_wb_uart_sbd.uart_tx_analysis_imp);
      m_uart_env.m_uart_rx_agent.m_uart_rx_monitor.uart_rx_analysis_port.connect(m_wb_uart_module_env.m_wb_uart_sbd.uart_rx_analysis_imp);
