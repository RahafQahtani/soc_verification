...
class base_test extends uvm_test;
    ...
    function void build_phase(uvm_phase phase);
        ...
        // uvm_config_wrapper::set(this, "m_wb_uart_tb.m_wb_env.m_wb_slave_agent.m_wb_slave_sequencer.run_phase",
        //                         "default_sequence", basic_slave_seq::get_type());
        //Creating the instance of wishbone testbench
        m_tb_name = "m_wb_uart_tb";
	m_wb_uart_tb = wb_uart_tb ::type_id::create(m_tb_name, this);
