...
class wb_base_seq  extends uvm_sequence #(wishbone_transaction);
  ...
  class UART_config_BD_9600_CL_8_PE_0 extends wb_base_seq;
  ...
  class UART_config_BD_9600_CL_8_PE_1_Even_1_Stop_0 extends wb_base_seq;
  ...
  class Read_IIR1 extends wb_base_seq;
  ...
  class Receiver_Line_Status_Interrupt_Seq extends wb_base_seq;
  ...
  class Read_IIR_1_2 extends wb_base_seq;
  ...
  class Empty_IER extends wb_base_seq;
...
//        `uvm_do_with(req, {req.adr_i == `UART_BASE_ADDRESS+`OFFSET*0; req.trans == WRITE; req.data == 2;})
  ...
  class UART_config_BD_9600_CL_8_PE_1_Even_1_Stop_0_SP_1 extends wb_base_seq;
  ...
  //Read after reset
  class Read_after_Reset extends wb_base_seq;
  ...
  class Enable_Loopback extends wb_base_seq;
  ...
  class Read_Receive_FIFO extends wb_base_seq;
  ...
  class UART_config_BD_4800_CL_8_PE_0 extends wb_base_seq;
  ...
  class UART_config_BD_115200_CL_8_PE_0 extends wb_base_seq;
  ...
  class Enable_Parity_Even_1 extends wb_base_seq;
...
class Read_IIR extends wb_base_seq;
...
class Read_LSR extends wb_base_seq;
...
class Clear_Reset_For_Rx_FIFO_in_FCR extends wb_base_seq;
...
class Clear_Reset_For_THR_FIFO_in_FCR extends wb_base_seq;
...
//Sequence to set the even parity = 0, baudrate = 9600, char_len = 5
  class UART_config_BD_9600_CL_5_PE_1_Even_0_Stop_0 extends wb_base_seq;
  ...
  class UART_config_BD_9600_CL_6_PE_1_Even_0_Stop_0 extends wb_base_seq;
  ...
  class UART_config_BD_9600_CL_7_PE_1_Even_0_Stop_0 extends wb_base_seq;
