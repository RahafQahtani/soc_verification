...
wb_mux
  #(.num_slaves (11),
	`ifdef tracer
	   	 ...
	   	 .MATCH_MASK ({32'hffffff80, 32'hffffff80,  32'hffffe000, 32'hffff8000, 32'hffffff00, 32'hffffff00, 32'hffffff80, 32'hffffff80, 32'hffffff00, 32'hffffff00, 32'hff000000}))
